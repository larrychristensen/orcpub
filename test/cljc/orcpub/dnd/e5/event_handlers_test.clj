...
(deftest test-set-class--maintain-armor-id
  (let [strict {:db/id 17592186056112, :orcpub.entity.strict/owner "larry", :orcpub.entity.strict/selections [{:db/id 17592186056113, :orcpub.entity.strict/key :ability-scores, :orcpub.entity.strict/option {:db/id 17592186056114, :orcpub.entity.strict/key :standard-scores, :orcpub.entity.strict/map-value {:db/id 17592186056115, :orcpub.dnd.e5.character/str 15, :orcpub.dnd.e5.character/dex 14, :orcpub.dnd.e5.character/con 13, :orcpub.dnd.e5.character/int 12, :orcpub.dnd.e5.character/wis 10, :orcpub.dnd.e5.character/cha 8}}} {:db/id 17592186056116, :orcpub.entity.strict/key :class, :orcpub.entity.strict/options [{:db/id 17592186056117, :orcpub.entity.strict/key :barbarian, :orcpub.entity.strict/selections [{:db/id 17592186056118, :orcpub.entity.strict/key :levels, :orcpub.entity.strict/options [{:db/id 17592186056119, :orcpub.entity.strict/key :level-1}]}]}]} {:db/id 17592186056120, :orcpub.entity.strict/key :weapons, :orcpub.entity.strict/options [{:db/id 17592186056121, :orcpub.entity.strict/key :javelin, :orcpub.entity.strict/map-value {:db/id 17592186056122, :orcpub.dnd.e5.character.equipment/quantity 4, :orcpub.dnd.e5.character.equipment/equipped? true, :orcpub.dnd.e5.character.equipment/class-starting-equipment? true}}]} {:db/id 17592186056123, :orcpub.entity.strict/key :equipment, :orcpub.entity.strict/options [{:db/id 17592186056124, :orcpub.entity.strict/key :explorers-pack, :orcpub.entity.strict/map-value {:db/id 17592186056125, :orcpub.dnd.e5.character.equipment/quantity 1, :orcpub.dnd.e5.character.equipment/equipped? true, :orcpub.dnd.e5.character.equipment/class-starting-equipment? true}}]}]}
        non-strict (entity/from-strict strict)
        class-selection (some (fn [s] (if (= :class (::t/key s)) s)) (t5e/template ::t/selections))
        class-options (::t/options class-selection)
        class-option-map (zipmap (map ::t/key class-options) class-options)
        updated (eh/set-class non-strict [:set-class :warlock 0 class-option-map])
        _ (prn "UDATED" updated)
        back-to-strict (entity/to-strict updated)]
