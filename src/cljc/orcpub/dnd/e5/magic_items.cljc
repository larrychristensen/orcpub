...
whose alignment matches the candle’s can cast 1stlevel
spells he or she has prepared without 
...
of feather tokens exist, each with a different singleuse
effect. The GM chooses the kind of token or 
determines it randomly.
...
The token disappears, and a 50-foot-long, 20-footwide
boat shaped like a swan takes its place. The 
...
o create a golem, you must spend the time shown 
...
use the pearl, it canʼt be used again until the next 
dawn.
-----
Periapt of Health
Wondrous item, uncommon
