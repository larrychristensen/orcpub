...
(defn selection-cfg [{:keys [name key source page order options help min sequential? multiselect? ui-fn new-item-fn prereq-fn tags ref icon different? require-value? show-if-zero? adder-key-fn] :as cfg}]
