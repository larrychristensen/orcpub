...
(def spell-map
 ...
 {:name "Dimension Door",
  ...
  :description
  "You teleport yourself from your current location to any other spot within range. You arrive at exactly the spot desired. It can be a place you can see, one you can visualize, or one you can describe by stating distance and direction, such as “200 feet straight downward” or “upward to the northwest at a 45-\ndegree angle, 300 feet.”\nYou can bring along objects as long as their weight doesn't exceed what you can carry. You can also bring one willing creature of your size or smaller who is carrying gear up to its carrying capacity. The creature must be within 5 feet of you when you cast this spell.\nIf you would arrive in a place already occupied by an object or a creature, you and any creature traveling with you each take 4d6 force damage, and the spell fails to teleport you."},
 ...
 {:name "Creation",
  ...
  :duration "Special",
  :description
  "You pull wisps of shadow material from the Shadowfell to create a nonliving object of vegetable matter within range: soft goods, rope, wood, or something similar. You can also use this spell to create mineral objects such as stone, crystal, or metal. The object created must be no larger than a 5-\nfoot cube, and the object must be of a form and material that you have seen before.\nThe duration depends on the object's material. If the object is composed of multiple materials, use the shortest duration.\nMaterial Duration\nVegetable matter 1 day\nStone or crystal 12 hours\nPrecious metals 1 hour\nGems 10 minutes\nAdamantine or mithral 1 minute\nUsing any material created by this spell as another spell's material component causes that spell to fail.\nAt Higher Levels. When you cast this spell using a spell slot of 6th level or higher, the cube increases by 5 feet for each slot level above 5th."},
 :glibness
 {:name "Glibness",
  :school "transmutation",
  :level 8,
 ...
 {:school "transmutation",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "arrows or bolts (4 or more)"},
  :casting-time "1 action",
  :range "5 feet"},
 :magic-mouth
 {:description
 ...
 {:name "Dancing Lights",
  ...
  :duration "Concentration, up to 1 minute",
  :description
  "You create up to four torch-sized lights within range, making them appear as torches, lanterns, or glowing orbs that hover in the air for the duration. You can also combine the four lights into one glowing vaguely humanoid form of Medium size. Whichever form you choose, each light sheds dim light in a 10-\nfoot radius.\nAs a bonus action on your turn, you can move the lights up to 60 feet to a new spot within range. A light must be within 20 feet of another light created by this spell, and a light winks out if it exceeds the spell's range."},
 :seeming
 {:name "Seeming",
  :school "illusion",
  :level 5,
 ...
 {:school "abjuration",
  ...
  :casting-time
  "1 reaction, in response to a creature casting a spell within 60 feet of you",
  :range "60 feet"},
 :acid-splash
 {:name "Acid Splash",
  :school "conjuration",
 ...
 {:name "Blindness/Deafness",
  ...
  :duration "1 minute",
  :description
  "You can blind or deafen a foe. Choose one creature that you can see within range to make a Constitution saving throw. If it fails, the target is either blinded or deafened (your choice) for the duration. At the end of each of its turns, the target can make a Constitution saving throw. On a success, the spell\nends.\nAt Higher Levels. When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd."},
 ...
 {:school "transmutation",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "thorny plant stem"},
  :casting-time "1 action",
  :range "30 feet"},
 :prismatic-spray
 ...
 {:school "conjuration",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "ammunition (1 piece) or throwing weapon"},
  :casting-time "1 action",
  :range "Self (60-foot cone)"},
 :dominate-beast
 {:name "Dominate Beast",
 ...
 {:description
  ...
  :name "Commune",
  :duration
  "1 minute You contact your deity or a divine proxy and ask up to three questions that can be answered with a yes or no. You must ask your questions before the spell ends. You receive a correct answer for each question.",
  :level 5,
  :components
  {:verbal true,
   :somatic true,
 ...
 {:name "Shield",
  ...
  :duration "1 round",
  :description
  "An invisible barrier of magical force appears and protects you. Until the start of your next turn, you have a +5 bonus to AC, including against the triggering attack, and you take no damage from\nmagic missile."},
 :conjure-celestial
 ...
 {:name "Polymorph",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a caterpillar cocoon"},
  :duration "Concentration, up to 1 hour",
  :description
 ...
 {:name "Magic Missile",
  ...
  :components {:verbal true, :somatic true},
  :duration
  "Instantaneous You create three glowing darts of magical force. Each dart hits a creature of your choice that you can see within range. A dart deals 1d4 + 1 force damage to its target. The darts all strike simultaneously, and you can direct them to hit one creature or several.",
  :description
 ...
 {:name "Regenerate",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a prayer wheel and holy water"},
  :duration "1 hour",
  :description
 ...
 {:school "evocation",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "twig of a lightning-struck tree"},
  :casting-time "1 action",
  :range "30 feet"},
 :hypnotic-pattern
 ...
 {:name "Forcecage",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "ruby dust worth 1,500 gp"},
  :duration "1 hour",
  :description
 ...
 {:school "necromancy",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "graveyard dirt (a pinch)"},
  :ritual true,
  :casting-time "1 action",
  :range "Touch"},
 :otil-s-freezing-sphere
 {:description
 ...
 {:name "Mending",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "two lodestones"},
  :duration "Instantaneous",
  :description
 ...
 {:name "Locate Object",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a forked twig"},
  :duration "Concentration, up to 10 minutes",
  :description
 ...
 {:name "Mirror Image",
  ...
  :components {:verbal true, :somatic true},
  :duration
  "1 minute Three illusory duplicates of yourself appear in your space. Until the spell ends, the duplicates move with you and mimic your actions, shifting position so it's impossible to track which image is real. You can use your action to dismiss the illusory duplicates.",
  :description
 ...
 {:name "Phantasmal Force",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "fleece (a bit)"},
  :duration "Concentration, up to 1 minute"},
 ...
 {:name "Fly",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a wing feather from any bird"},
  :duration "Concentration, up to 10 minutes",
  :description
 ...
 {:school "transmutation",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "quiver with minimum 1 piece ammunition"},
  :casting-time "1 bonus action",
  :range "Touch"},
 :heroes-feast
 {:name "Heroes' Feast",
  ...
  :duration
  "Instantaneous You bring forth a great feast, including magnificent food and drink. The feast takes 1 hour to consume and disappears at the end of that time, and the beneficial effects don't set in until this hour is over. Up to twelve other creatures can partake of the feast.",
  :description
 ...
 {:name "Tongues",
  ...
  {:verbal true,
   :material true,
   :material-component "a small clay model of a ziggurat"},
  :duration "1 hour",
  :description
 ...
 {:school "enchantment",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "eye of a newt (petrified)"},
  :casting-time "1 bonus action",
  :range "90 feet"},
 :divination
 {:description
 ...
 {:school "enchantment",
  ...
  {:somatic true,
   :material true,
   :material-component
   "apply a bit of makeup while casting the spell"},
  :casting-time "1 action",
  :range "Self"},
 :find-traps
 {:name "Find Traps",
 ...
 {:name "Flesh to Stone",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a pinch of lime, water, and earth"},
  :duration "Concentration, up to 1 minute",
  :description
 ...
 {:name "Wall of Thorns",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a handful of thorns"},
  :duration "Concentration, up to 10 minutes",
  :description
 ...
 {:description
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a small crystal bead"},
  :ritual true,
  :casting-time "1 minute",
 ...
 {:school "enchantment",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a bit of food"},
  :casting-time "1 action",
  :range "30 feet"},
 :unseen-servant
 {:description
 ...
 {:name "Clone",
  ...
  {:verbal true,
   ...
   :material true,
   :material-component
   "a diamond worth at least 1,000 gp and at least 1 cubic inch of flesh of the creature that is to be cloned, which the spell consumes, and a vessel worth at least 2,000 gp that has a sealable lid and is large enough to hold a Medium creature, such as a huge urn, coffin, mudfilled\ncyst in the ground, or crystal container filled with salt water"},
  :duration "Instantaneous",
  :description
 ...
 {:school "conjuration",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "octopus tentacle (pickled)"},
  :casting-time "1 action",
  :range "150 feet"},
 :false-life
 {:name "False Life",
 ...
 {:school "evocation",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "2 silver rings, linked"},
  :casting-time "1 action",
  :range "Unlimited"},
 :healing-word
 {:name "Healing Word",
 ...
 {:name "Flame Strike",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "pinch of sulfur"},
  :duration "Instantaneous",
  :description
 ...
 {:name "Wind Walk",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "fire and holy water"},
  :duration "8 hours",
  :description
 ...
 {:name "Sunburst",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "fire and a piece of sunstone"},
  :duration "Instantaneous",
  :description
 ...
 {:name "Foresight",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a hummingbird feather"},
  :duration "8 hours",
  :description
 ...
 {:name "Flame Blade",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "leaf of sumac"},
  :duration "Concentration, up to 10 minutes",
  :description
 ...
 {:school "conjuration",
  ...
  {:verbal true,
   ...
   :material true,
   :material-component
   "charcoal, herbs, and incense (10 gp worth) consumed in a fire in a brass brazier."},
  :ritual true,
  :casting-time "1 hour",
  :range "10 feet"},
 :tens-s-floating-disk
 {:description
 ...
 {:name "Gust of Wind",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a legume seed"},
  :duration "Concentration, up to 1 minute",
  :description
 ...
 {:description
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a piece of cork"},
  :ritual true,
  :casting-time "1 action",
  :range "30 feet"},
 :fear
 ...
 {:name "Spider Climb",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a drop of bitumen and a spider"},
  :duration "Concentration, up to 1 hour",
  :description
 ...
 {:name "Heat Metal",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "a piece of iron and a flame"},
  :duration "Concentration, up to 1 minute",
  :description
 ...
 {:name "Create Undead",
  ...
  {:verbal true,
   ...
   :material true,
   :material-component
   "one clay pot filled with grave dirt, one clay pot filled with brackish water, and\none 150 gp black onyx stone for each corpse"},
  :duration "Instantaneous",
  :description
 ...
 {:school "transmutation",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "mistletoe sprig"},
  :casting-time "1 action",
  :range "Touch"},
 :web
 {:name "Web",
 ...
 {:school "evocation",
  ...
  {:verbal true,
   :somatic true,
   :material true,
   :material-component "diamond (50 gp value min.)"},
  :casting-time "1 action",
  :range "90 feet"},
 :misty-step
 {:name "Misty Step",
