               ...
               {:title     "What choices do you have about your information?"
                ...
                :paragraphs
                           (if (not (s/blank? (environ/env :email-access-key)))
                             ["You may close your account at any time by emailing " (environ/env :email-access-key) "We will then inactivate your account and remove your content from OrcPub. We may retain archived copies of you information as required by law or for legitimate business purposes (including to help address fraud and spam). "]
                             ["You may remove any content you create from OrcPub at any time, although we may retain archived copies of the information. You may also disable sharing of content you create at any time, whether publicly shared or privately shared with specific users."
     ...
     [:div.app-header-bar.container
      ...
      [:div.content
       [:div.flex.justify-cont-s-b.align-items-c.w-100-p.p-l-20.p-r-20
        [:img.h-60 {:src "/image/dmv-logo.svg"}]]]]
     [:div.container
      [:div.content
       [:div.f-s-24
        (section sections)]]]]]))
...
"]}
      ...
      {:title "Parties"
       :font-size 28
       :paragraphs
       ["These Terms are a contract between you and OrcPub"
